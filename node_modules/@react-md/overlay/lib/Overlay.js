...
exports.Overlay = (0, react_1.forwardRef)(function Overlay(_a, nodeRef) {
    ...
    return ((0, jsx_runtime_1.jsx)(portal_1.ConditionalPortal, __assign({ portal: portal, portalInto: portalInto, portalIntoId: portalIntoId }, { children: (0, jsx_runtime_1.jsx)(transition_1.CSSTransition, __assign({ appear: true, nodeRef: nodeRef, transitionIn: visible, classNames: hidden ? "" : classNames, timeout: hidden ? 0 : timeout, temporary: temporary, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, { children: (0, jsx_runtime_1.jsx)("span", __assign({}, props, { className: (0, classnames_1.default)(block({
                    ...
                    onRequestClose();
                }, tabIndex: tabIndex }, { children: children }), void 0) }), void 0) }), void 0));
});
