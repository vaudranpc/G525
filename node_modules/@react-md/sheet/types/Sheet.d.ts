...
import { BaseDialogProps } from "@react-md/dialog";
import { LabelRequiredForA11y } from "@react-md/utils";
declare type AllowedDialogProps = Omit<BaseDialogProps, "role" | "type" | "modal" | "forceContainer">;
/**
 * The location that the sheet should be located within the viewport.
 */
export declare type SheetPosition = "top" | "right" | "bottom" | "left";
/**
 ...
 */
export declare type SheetHorizontalSize = "none" | "media" | "touch" | "static";
/**
 ...
 */
export declare type SheetVerticalSize = "none" | "touch" | "recommended";
...
export declare type SheetProps = LabelRequiredForA11y<BaseSheetProps>;
/**
