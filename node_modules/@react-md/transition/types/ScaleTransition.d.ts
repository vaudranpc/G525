...
import { ScaleTransitionHookOptions } from "./useScaleTransition";
/**
 ...
 */
export interface ScaleTransitionProps<E extends HTMLElement> extends CSSTransitionComponentImplementation<E>, RenderConditionalPortalProps, ScaleTransitionHookOptions<E> {
}
/**
 ...
 */
export declare function ScaleTransition<E extends HTMLElement>({ portal, portalInto, portalIntoId, children, className, ...options }: ScaleTransitionProps<E>): ReactElement;
