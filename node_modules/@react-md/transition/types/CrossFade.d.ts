...
import { CrossFadeTransitionHookOptions } from "./useCrossFadeTransition";
/**
 ...
 */
export interface CrossFadeProps<E extends HTMLElement> extends CrossFadeTransitionHookOptions<E>, CSSTransitionComponentImplementation<E> {
    /**
 ...
 */
export declare function CrossFade<E extends HTMLElement>({ appear, transitionIn, children, className, ...options }: CrossFadeProps<E>): ReactElement | null;
