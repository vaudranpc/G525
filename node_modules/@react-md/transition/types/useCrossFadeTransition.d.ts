import type { CSSTransitionClassNames, CSSTransitionClassNamesObject, CSSTransitionHookReturnValue, PreconfiguredCSSTransitionInDefaultedOptions, TransitionTimeout, TransitionTimeoutObject } from "./types";
/**
 * The default cross fade transition classes to use.
 *
 * @remarks \@since 2.0.0
 */
export declare const CROSS_FADE_CLASSNAMES: Readonly<CSSTransitionClassNamesObject>;
/**
 * The default cross fade transition timeout.
 *
 * @remarks \@since 2.0.0
 */
export declare const CROSS_FADE_TIMEOUT: Readonly<TransitionTimeoutObject>;
/**
 * @typeParam E - An HTMLElement type used for the ref required for the
 * transition.
 * @remarks \@since 4.0.0
 */
export interface CrossFadeTransitionHookOptions<E extends HTMLElement> extends PreconfiguredCSSTransitionInDefaultedOptions<E> {
    /**
 ...
 * @remarks \@since 4.0.0
 */
export declare function useCrossFadeTransition<E extends HTMLElement>({ transitionIn, timeout, classNames, ...options }?: CrossFadeTransitionHookOptions<E>): CSSTransitionHookReturnValue<E>;
