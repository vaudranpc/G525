...
import { CollapseElementProps, CollapseTransitionHookOptions } from "./useCollapseTransition";
/**
 ...
 */
export interface CollapseProps<E extends HTMLElement> extends Omit<CollapseTransitionHookOptions<E>, "transitionIn"> {
    /**
 ...
 * @remarks \@since 4.0.0 Updated for the new CSS Transition API.
 */
export declare function Collapse<E extends HTMLElement>({ children, collapsed, className, ...options }: CollapseProps<E>): ReactElement | null;
