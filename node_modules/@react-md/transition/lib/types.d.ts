 ...
 * @remarks \@since 4.0.0
 */
export declare type TransitionTimeout = number | Readonly<TransitionTimeoutObject>;
/**
 ...
 * @remarks \@since 4.0.0
 */
export declare type TransitionStage = "enter" | "entering" | "entered" | "exit" | "exiting" | "exited";
/**
 ...
 * @remarks \@since 4.0.0
 */
export declare type TransitionEnterHandler = (appearing: boolean) => void;
/**
 ...
 * @remarks \@since 4.0.0
 */
export declare type TransitionExitHandler = () => void;
/**
 * @remarks \@since 4.0.0
 */
 ...
 * @remarks \@since 4.0.0
 */
export declare type CSSTransitionClassNames = string | Readonly<CSSTransitionClassNamesObject>;
/**
 * @typeParam E - An HTMLElement type used for the ref required for the
 * transition.
 * @remarks \@since 4.0.0
 ...
 * @remarks \@since 4.0.0
 */
export interface PreconfiguredCSSTransitionOptions<E extends HTMLElement> extends PreconfiguredCSSTransitionInDefaultedOptions<E> {
    /** {@inheritDoc PreconfiguredTransitionInDefaultedOptions.transitionIn} */
    transitionIn: boolean;
}
/**
 ...
 * @remarks \@since 4.0.0
 */
export interface CSSTransitionHookReturnValue<E extends HTMLElement> extends TransitionHookReturnValue<E>, CSSTransitionElementProps<E> {
    /**
 ...
 * @remarks \@since 4.0.0
 */
export declare type FixedPositioningTransitionCallbacks = Pick<TransitionCallbacks, "onEnter" | "onEntering" | "onEntered" | "onExited">;
/**
 ...
 * @remarks \@since 4.0.0
 */
export interface FixedPositioningTransitionOptions<E extends HTMLElement> extends FixedPositioningTransitionCallbacks {
 ...
 * @remarks \@since 4.0.0
 */
export declare type TransitionScrollCallback<FixedToElement extends HTMLElement, FixedElement extends HTMLElement> = (event: Event, data: Readonly<FixedPositioningScrollData<FixedToElement, FixedElement>>) => void;
