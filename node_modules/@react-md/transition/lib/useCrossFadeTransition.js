...
exports.useCrossFadeTransition = exports.CROSS_FADE_TIMEOUT = exports.CROSS_FADE_CLASSNAMES = void 0;
...
function useCrossFadeTransition(_a) {
    if (_a === void 0) { _a = {}; }
    var _b = _a.transitionIn, transitionIn = _b === void 0 ? true : _b, _c = _a.timeout, timeout = _c === void 0 ? exports.CROSS_FADE_TIMEOUT : _c, _d = _a.classNames, classNames = _d === void 0 ? exports.CROSS_FADE_CLASSNAMES : _d, options = __rest(_a, ["transitionIn", "timeout", "classNames"]);
    return (0, useCSSTransition_1.useCSSTransition)(__assign(__assign({}, options), { timeout: timeout, classNames: classNames, transitionIn: transitionIn }));
}
