...
function Collapse(_a) {
    ...
    var _b = (0, useCollapseTransition_1.useCollapseTransition)(__assign(__assign({}, options), { className: (0, classnames_1.default)(child.props.className, className), transitionIn: !collapsed })), elementProps = _b.elementProps, rendered = _b.rendered;
    if (!rendered) {
        return null;
    }
