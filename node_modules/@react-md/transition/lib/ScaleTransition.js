...
function ScaleTransition(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(portal_1.ConditionalPortal, __assign({ portal: portal, portalInto: portalInto, portalIntoId: portalIntoId }, { children: rendered && (0, react_1.cloneElement)(children, elementProps) }), void 0));
}
