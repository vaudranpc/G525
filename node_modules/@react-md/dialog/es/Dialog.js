...
export var Dialog = forwardRef(function Dialog(_a, nodeRef) {
    ...
    if (typeof propOverlay === "boolean" ? propOverlay : !isFullPage) {
        ...
        overlayEl = (_jsx(Overlay, __assign({ id: "".concat(id, "-overlay") }, overlayProps, { style: overlayStyle, className: cn("rmd-dialog-overlay", overlayClassName), hidden: overlayHidden || disableOverlay, visible: visible, clickable: !modal, onRequestClose: modal ? noop : onRequestClose }), void 0));
    }
    ...
    if (isCentered || forceContainer) {
        ...
        dialog = (_jsx("span", __assign({ id: "".concat(id, "-container"), style: containerStyle, className: cn("rmd-dialog-container", containerClassName) }, { children: dialog }), void 0));
    }
    return (_jsxs(ConditionalPortal, __assign({ portal: !isNoneRole && portal, portalInto: portalInto, portalIntoId: portalIntoId }, { children: [overlayEl, rendered && dialog] }), void 0));
});
