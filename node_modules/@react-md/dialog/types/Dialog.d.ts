...
export interface BaseDialogProps extends CSSTransitionComponentProps, TransitionActions, RenderConditionalPortalProps, FocusContainerOptionsProps, HTMLAttributes<HTMLDivElement> {
    /**
