...
exports.Dialog = (0, react_1.forwardRef)(function Dialog(_a, nodeRef) {
    ...
    if (typeof propOverlay === "boolean" ? propOverlay : !isFullPage) {
        ...
        overlayEl = ((0, jsx_runtime_1.jsx)(overlay_1.Overlay, __assign({ id: "".concat(id, "-overlay") }, overlayProps, { style: overlayStyle, className: (0, classnames_1.default)("rmd-dialog-overlay", overlayClassName), hidden: overlayHidden || disableOverlay, visible: visible, clickable: !modal, onRequestClose: modal ? noop : onRequestClose }), void 0));
    }
    ...
    if (isCentered || forceContainer) {
        ...
        dialog = ((0, jsx_runtime_1.jsx)("span", __assign({ id: "".concat(id, "-container"), style: containerStyle, className: (0, classnames_1.default)("rmd-dialog-container", containerClassName) }, { children: dialog }), void 0));
    }
    return ((0, jsx_runtime_1.jsxs)(portal_1.ConditionalPortal, __assign({ portal: !isNoneRole && portal, portalInto: portalInto, portalIntoId: portalIntoId }, { children: [overlayEl, rendered && dialog] }), void 0));
});
