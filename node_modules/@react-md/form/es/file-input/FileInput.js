...
export var FileInput = forwardRef(function FileInput(_a, ref) {
    ...
    if (typeof propChildren === "undefined") {
        children = _jsx(SrOnly, { children: "Upload" }, void 0);
    }
    ...
    if (disableIconSpacing || (children && !icon)) {
        content = (_jsxs(_Fragment, { children: [!iconAfter && icon, children, iconAfter && icon] }, void 0));
    }
    else if (children) {
        content = (_jsx(TextIconSpacing, __assign({ icon: icon, iconAfter: iconAfter }, { children: children }), void 0));
    }
    return (_jsxs(_Fragment, { children: [_jsx("input", __assign({}, props, handlers, { ref: ref, onChange: onChange, value: disableRepeatableFiles ? undefined : "", type: "file", className: block(), multiple: multiple }), void 0), _jsxs("label", __assign({ htmlFor: id, style: style, className: cn("rmd-file-input-label", className) }, { children: [content, ripples] }), void 0)] }, void 0));
});
