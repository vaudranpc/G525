...
export var TextFieldContainer = forwardRef(function TextFieldContainer(_a, ref) {
    ...
    return (_jsxs("div", __assign({}, props, { ref: ref, className: cn(block((_b = {
            ...
            _b)), className) }, { children: [isLeftAddon ? (_jsx(TextFieldAddon, { children: leftChildren }, void 0)) : (leftChildren), children, isRightAddon ? (_jsx(TextFieldAddon, { children: rightChildren }, void 0)) : (rightChildren)] }), void 0));
});
