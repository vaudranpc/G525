...
export var MenuItemInputToggle = forwardRef(function MenuItemInputToggle(_a, nodeRef) {
    ...
    if (type === "switch" && typeof propIcon === "undefined") {
        icon = _jsx(SwitchTrack, { checked: checked }, void 0);
    }
    else if (icon && type !== "switch") {
        icon = (_jsx("span", __assign({ className: cn("rmd-toggle", styles("toggle")) }, { children: _jsx(InputToggleIcon, __assign({ circle: type === "radio", disabled: disabled, overlay: true, checked: checked, indeterminate: indeterminate }, { children: icon }), void 0) }), void 0));
    }
    var leftAddon;
    var leftAddonType;
    ...
    return (_jsx(ListItem, __assign({}, props, { disableRipple: true, "aria-disabled": disabled || undefined, "aria-checked": checked, role: type === "radio" ? "menuitemradio" : "menuitemcheckbox", onClick: function (event) {
        ...
        }, ref: ref, className: cn(styles({ switch: type === "switch" }), className), tabIndex: tabIndex, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition }, { children: children }), void 0));
});
