...
exports.FormMessage = (0, react_1.forwardRef)(function FormMessage(_a, ref) {
    ...
    if (!disableWrap && children) {
        message = ((0, jsx_runtime_1.jsx)("p", __assign({ id: "".concat(id, "-message"), style: messageStyle, className: (0, classnames_1.default)(block("message"), messageClassName) }, { children: children }), void 0));
    }
    return ((0, jsx_runtime_1.jsxs)("div", __assign({}, props, { id: id, ref: ref, "aria-live": role !== "alert" ? "polite" : undefined, role: role, className: (0, classnames_1.default)(block((_b = {
            ...
            _b[theme] = theme !== "none",
            _b)), className) }, { children: [message, typeof length === "number" && typeof maxLength === "number" && ((0, jsx_runtime_1.jsx)(FormMessageCounter_1.FormMessageCounter, __assign({ id: "".concat(id, "-counter"), style: counterStyle, className: counterClassName }, { children: "".concat(length, " / ").concat(maxLength) }), void 0))] }), void 0));
});
