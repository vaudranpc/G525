...
exports.Option = (0, react_1.forwardRef)(function Option(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(list_1.SimpleListItem, __assign({}, props, { ref: ref, role: "option", "aria-selected": selected || undefined, clickable: true, className: (0, classnames_1.default)(block({
            selected: selected,
            focused: focused,
        }), className), textChildren: textChildren }, { children: children }), void 0));
});
