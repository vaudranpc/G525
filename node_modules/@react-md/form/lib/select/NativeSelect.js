...
exports.NativeSelect = (0, react_1.forwardRef)(function NativeSelect(_a, ref) {
    ...
    var _g = (0, FormThemeProvider_1.useFormTheme)({
        theme: propTheme,
    ...
    var _h = (0, useFieldStates_1.useFieldStates)({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    ...
    return ((0, jsx_runtime_1.jsxs)(TextFieldContainer_1.TextFieldContainer, __assign({ style: style, className: (0, classnames_1.default)(container({
            multi: multiple,
            padded: multiple && label,
        }), className), ref: containerRef, theme: theme, error: error, active: focused, label: !!label, dense: dense, inline: inline, stretch: stretch, disabled: disabled, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, leftChildren: leftChildren, rightChildren: multiple && rightChildren, underlineDirection: underlineDirection }, { children: [(0, jsx_runtime_1.jsx)(FloatingLabel_1.FloatingLabel, __assign({ style: labelStyle, className: (0, classnames_1.default)(block("label"), labelClassName), htmlFor: id, error: error, active: valued && focused, valued: valued, floating: valued || multiple, dense: dense, disabled: disabled }, { children: label }), void 0), (0, jsx_runtime_1.jsx)("select", __assign({}, props, { ref: ref, style: selectStyle, className: (0, classnames_1.default)(block({
                    icon: icon,
                    multi: multiple,
                    "label-underline": label && underline,
                    "placeholder-underline": !label && underline,
                    floating: label && theme !== "none",
                }), selectClassName), disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange }, { children: children }), void 0), !multiple && icon && (0, jsx_runtime_1.jsx)("span", __assign({ className: block("icon") }, { children: icon }), void 0)] }), void 0));
});
