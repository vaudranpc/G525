...
function useSliderControls(_a) {
    ...
    var _g = __read((0, react_1.useState)(false), 2), dragging = _g[0], setDragging = _g[1];
    var _h = __read((0, react_1.useState)(min), 2), dragValue = _h[0], setDragValue = _h[1];
    var _j = __read((0, react_1.useState)(null), 2), draggingBy = _j[0], setDraggingBy = _j[1];
    var _k = __read((0, react_1.useState)(null), 2), draggingIndex = _k[0], setDraggingIndex = _k[1];
    ...
    var drag = (0, react_1.useCallback)(function (event) {
        ...
        if (!(0, utils_2.isTouchEvent)(event) || event.type === "touchmove") {
