...
exports.SliderThumb = (0, react_1.forwardRef)(function SliderThumb(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [disabled && ((0, jsx_runtime_1.jsx)("span", { className: (0, classnames_1.default)(styles(__assign(__assign({}, styleOptions), { mask: true, "mask-h": !vertical, "mask-v": vertical })), className) }, void 0)), (0, jsx_runtime_1.jsx)("span", __assign({}, props, { id: id, ref: ref, role: "slider", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, "aria-valuetext": getValueText(value) || undefined, "aria-disabled": disabled || undefined, "aria-orientation": (vertical && "vertical") || undefined, tabIndex: tabIndex, onBlur: onBlur, onFocus: onFocus, className: (0, classnames_1.default)(styles(__assign(__assign({}, styleOptions), { "disabled-h": disabled && !vertical, "disabled-v": disabled && vertical })), className) }), void 0), (0, jsx_runtime_1.jsx)("input", { id: "".concat(id, "-value"), type: "hidden", name: name, value: value }, void 0), (0, jsx_runtime_1.jsx)(SliderValue_1.SliderValue, __assign({ id: "".concat(id, "-value"), visible: visible, index: index, animate: animateValue, discrete: discrete, vertical: vertical }, { children: value }), void 0)] }, void 0));
});
