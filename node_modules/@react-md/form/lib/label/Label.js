...
exports.Label = (0, react_1.forwardRef)(function Label(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Component, __assign({}, props, { ref: ref, className: (0, classnames_1.default)((0, exports.labelStyles)({ error: error, active: active, disabled: disabled }), className), htmlFor: Component === "label" ? htmlFor : undefined }, { children: children }), void 0));
});
