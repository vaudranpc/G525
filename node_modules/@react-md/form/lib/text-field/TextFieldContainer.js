...
exports.TextFieldContainer = (0, react_1.forwardRef)(function TextFieldContainer(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block((_b = {
                error: error,
                inline: inline,
                stretch: stretch,
                filled: filled,
            ...
            _b)), className) }, { children: [isLeftAddon ? ((0, jsx_runtime_1.jsx)(TextFieldAddon_1.TextFieldAddon, { children: leftChildren }, void 0)) : (leftChildren), children, isRightAddon ? ((0, jsx_runtime_1.jsx)(TextFieldAddon_1.TextFieldAddon, { children: rightChildren }, void 0)) : (rightChildren)] }), void 0));
});
