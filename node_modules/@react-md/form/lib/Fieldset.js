...
exports.Fieldset = (0, react_1.forwardRef)(function Fieldset(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("fieldset", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({ unstyled: unstyled }), className) }, { children: [(0, jsx_runtime_1.jsx)("legend", __assign({ style: legendStyle, className: (0, classnames_1.default)(block("legend", { "sr-only": legendSROnly }), legendClassName) }, { children: legend }), void 0), children] }), void 0));
});
