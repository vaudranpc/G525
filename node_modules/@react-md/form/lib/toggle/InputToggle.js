...
exports.InputToggle = (0, react_1.forwardRef)(function InputToggle(allProps, ref) {
    ...
    var labelEl = ((0, jsx_runtime_1.jsx)(Label_1.Label, __assign({ style: labelStyle, className: labelClassName, htmlFor: id, error: error, disabled: typeof labelDisabled === "boolean" ? labelDisabled : disabled }, { children: label }), void 0));
    return ((0, jsx_runtime_1.jsxs)(ToggleContainer_1.ToggleContainer, __assign({ style: style, className: className, inline: inline, stacked: stacked }, { children: [iconAfter && labelEl, (0, jsx_runtime_1.jsxs)("span", __assign({ style: toggleStyle, className: (0, classnames_1.default)(block({
                    focused: focused,
                    disabled: disabled,
                }), toggleClassName) }, { children: [(0, jsx_runtime_1.jsx)("input", __assign({}, props, handlers, { ref: ref, style: inputStyle, disabled: disabled, onFocus: onFocus, onBlur: onBlur, className: (0, classnames_1.default)(block("input"), inputClassName) }), void 0), (0, jsx_runtime_1.jsx)(InputToggleIcon_1.InputToggleIcon, __assign({ circle: !disableIconOverlay && type === "radio", disabled: disabled, overlay: !disableIconOverlay, indeterminate: indeterminate, style: iconStyle, className: iconClassName }, { children: icon }), void 0), ripples, children] }), void 0), !iconAfter && labelEl] }), void 0));
});
