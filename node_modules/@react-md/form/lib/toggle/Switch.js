...
exports.Switch = (0, react_1.forwardRef)(function Switch(_a, ref) {
    ...
    var id = props.id;
    return ((0, jsx_runtime_1.jsx)(ToggleContainer_1.ToggleContainer, __assign({ style: style, className: (0, classnames_1.default)("rmd-switch-container", className), inline: inline, stacked: stacked }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: (0, jsx_runtime_1.jsx)(Label_1.Label, __assign({ style: labelStyle, className: labelClassName, htmlFor: id, error: error, disabled: labelDisabled !== null && labelDisabled !== void 0 ? labelDisabled : disabled }, { children: label }), void 0), iconAfter: !iconAfter }, { children: (0, jsx_runtime_1.jsx)(SwitchTrack_1.SwitchTrack, __assign({}, props, { ref: ref, style: trackStyle, className: trackClassName, disabled: disabled, ballStyle: ballStyle, ballClassName: ballClassName }, { children: children }), void 0) }), void 0) }), void 0));
});
