...
exports.FileInput = (0, react_1.forwardRef)(function FileInput(_a, ref) {
    ...
    if (typeof propChildren === "undefined") {
        children = (0, jsx_runtime_1.jsx)(typography_1.SrOnly, { children: "Upload" }, void 0);
    }
    ...
    if (disableIconSpacing || (children && !icon)) {
        content = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!iconAfter && icon, children, iconAfter && icon] }, void 0));
    }
    else if (children) {
        content = ((0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: icon, iconAfter: iconAfter }, { children: children }), void 0));
    }
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("input", __assign({}, props, handlers, { ref: ref, onChange: onChange, value: disableRepeatableFiles ? undefined : "", type: "file", className: block(), multiple: multiple }), void 0), (0, jsx_runtime_1.jsxs)("label", __assign({ htmlFor: id, style: style, className: (0, classnames_1.default)("rmd-file-input-label", className) }, { children: [content, ripples] }), void 0)] }, void 0));
});
