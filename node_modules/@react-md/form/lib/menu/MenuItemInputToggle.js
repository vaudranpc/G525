...
exports.MenuItemInputToggle = (0, react_1.forwardRef)(function MenuItemInputToggle(_a, nodeRef) {
    ...
    if (type === "switch" && typeof propIcon === "undefined") {
        icon = (0, jsx_runtime_1.jsx)(SwitchTrack_1.SwitchTrack, { checked: checked }, void 0);
    }
    else if (icon && type !== "switch") {
        icon = ((0, jsx_runtime_1.jsx)("span", __assign({ className: (0, classnames_1.default)("rmd-toggle", styles("toggle")) }, { children: (0, jsx_runtime_1.jsx)(InputToggleIcon_1.InputToggleIcon, __assign({ circle: type === "radio", disabled: disabled, overlay: true, checked: checked, indeterminate: indeterminate }, { children: icon }), void 0) }), void 0));
    }
    var leftAddon;
    var leftAddonType;
    ...
    return ((0, jsx_runtime_1.jsx)(list_1.ListItem, __assign({}, props, { disableRipple: true, "aria-disabled": disabled || undefined, "aria-checked": checked, role: type === "radio" ? "menuitemradio" : "menuitemcheckbox", onClick: function (event) {
        ...
        }, ref: ref, className: (0, classnames_1.default)(styles({ switch: type === "switch" }), className), tabIndex: tabIndex, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition }, { children: children }), void 0));
});
