...
exports.MenuItemTextField = void 0;
 ...
 * @remarks \@since 5.0.0
 */
exports.MenuItemTextField = (0, react_1.forwardRef)(function MenuItemTextField(_a, nodeRef) {
    ...
    var refCallback = (0, utils_1.useKeyboardFocusableElement)(nodeRef);
    return ((0, jsx_runtime_1.jsx)("li", __assign({ role: "none" }, liProps, { onClick: function (event) {
            var _a;
            (_a = liProps === null || liProps === void 0 ? void 0 : liProps.onClick) === null || _a === void 0 ? void 0 : _a.call(liProps, event);
            event.stopPropagation();
        }, className: (0, classnames_1.default)("rmd-list-item rmd-menu-item", liProps === null || liProps === void 0 ? void 0 : liProps.className) }, { children: (0, jsx_runtime_1.jsx)(TextField_1.TextField, __assign({}, props, { ref: refCallback, stretch: stretch, onKeyDown: function (event) {
