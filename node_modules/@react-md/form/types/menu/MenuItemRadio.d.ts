...
/** @remarks \@since 2.8.0 */
export declare type MenuItemRadioProps = BaseMenuItemInputToggleProps;
/**
 ...
 * @remarks \@since 2.8.0
 */
export declare const MenuItemRadio: import("react").ForwardRefExoticComponent<BaseMenuItemInputToggleProps & import("react").RefAttributes<HTMLLIElement>>;
