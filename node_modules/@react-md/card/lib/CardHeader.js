...
exports.CardHeader = (0, react_1.forwardRef)(function CardHeader(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("header", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block("header", (_b = {},
            _b[align] = align !== "none",
            _b)), className) }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: (0, jsx_runtime_1.jsx)(CardHeaderAddon_1.CardHeaderAddon, { children: beforeChildren }, void 0) }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: (0, jsx_runtime_1.jsx)(CardHeaderAddon_1.CardHeaderAddon, { children: afterChildren }, void 0), iconAfter: true }, { children: (0, jsx_runtime_1.jsx)("span", __assign({ className: (0, classnames_1.default)(block("header-content"), contentClassName) }, { children: children }), void 0) }), void 0) }), void 0) }), void 0));
});
