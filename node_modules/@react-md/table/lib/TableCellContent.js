...
exports.TableCellContent = (0, react_1.forwardRef)(function TableCellContent(_a, ref) {
    ...
    if (sortOrder !== "none") {
        ...
        icon = (0, jsx_runtime_1.jsx)(icon_1.IconRotator, __assign({ rotated: rotated }, { children: propIcon }), void 0);
    }
    return ((0, jsx_runtime_1.jsx)(button_1.UnstyledButton, __assign({ id: id, ref: ref, style: style, className: (0, classnames_1.default)(block("child", (_b = {},
            ...
            _b)), className) }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({}, props, { icon: icon }, { children: children }), void 0) }), void 0));
});
