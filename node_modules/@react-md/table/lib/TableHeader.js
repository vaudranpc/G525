...
exports.TableHeader = (0, react_1.forwardRef)(function TableHeader(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(config_1.TableConfigProvider, __assign({ value: configuration }, { children: (0, jsx_runtime_1.jsx)("thead", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block(), className) }, { children: (0, jsx_runtime_1.jsx)(sticky_1.StickyTableProvider, __assign({ value: sticky }, { children: children }), void 0) }), void 0) }), void 0));
});
