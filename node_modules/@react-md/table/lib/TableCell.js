...
exports.TableCell = (0, react_1.forwardRef)(function TableCell(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Component, __assign({}, props, { ref: ref, id: id, "aria-sort": sortOrder === "none" ? undefined : sortOrder, colSpan: colSpan, className: (0, classnames_1.default)(block((_b = {
                grow: grow,
                header: header,
                sticky: sticky,
            ...
            _b)), className), scope: scope }, { children: (0, jsx_runtime_1.jsx)(TableCellContent_1.TableCellContent, __assign({ id: id ? "".concat(id, "-sort") : undefined, icon: sortIcon, iconAfter: sortIconAfter, sortOrder: sortOrder, rotated: sortIconRotated, hAlign: hAlign }, { children: children }), void 0) }), void 0));
});
