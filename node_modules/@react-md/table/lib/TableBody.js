...
exports.TableBody = (0, react_1.forwardRef)(function TableBody(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(config_1.TableConfigProvider, __assign({ value: configuration }, { children: (0, jsx_runtime_1.jsx)("tbody", __assign({}, props, { ref: ref, className: (0, classnames_1.default)("rmd-tbody", className) }, { children: children }), void 0) }), void 0));
});
