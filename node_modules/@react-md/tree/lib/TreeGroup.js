 ...
 */
exports.TreeGroup = (0, react_1.forwardRef)(function TreeGroup(_a, nodeRef) {
    ...
    var _b = (0, transition_1.useCollapseTransition)({
        style: style,
        className: (0, classnames_1.default)("rmd-tree-group", className),
        nodeRef: nodeRef,
        minHeight: minHeight,
    ...
    return ((0, jsx_runtime_1.jsx)(list_1.List, __assign({}, props, elementProps, { role: "group" }, { children: children }), void 0));
});
