...
exports.TreeItem = (0, react_1.forwardRef)(function TreeItem(_a, ref) {
    ...
    if (renderChildItems) {
        var icon = ((0, jsx_runtime_1.jsx)(TreeItemExpanderIcon_1.TreeItemExpanderIcon, __assign({ rotated: expanded }, { children: expanderIcon }), void 0));
        if (expanderLeft) {
            leftAddon = icon;
        }
        else {
        ...
        group = (0, jsx_runtime_1.jsx)(TreeGroup_1.TreeGroup, __assign({ collapsed: !expanded }, { children: renderChildItems() }), void 0);
    }
    ...
    return ((0, jsx_runtime_1.jsxs)("li", __assign({}, (isLink ? noA11y : a11y), { ref: liRef, style: liStyle, className: (0, classnames_1.default)(block(), liClassName) }, { children: [(0, jsx_runtime_1.jsxs)(Content, __assign({}, props, (isLink ? a11y : undefined), { ref: ref, className: (0, classnames_1.default)(block("content", (_b = {
                        link: isLink,
                    ...
                    _b.focused = focused,
                    _b)), className) }, { children: [(0, jsx_runtime_1.jsx)(list_1.ListItemChildren, __assign({ textClassName: textClassName, secondaryTextClassName: secondaryTextClassName, textChildren: textChildren, primaryText: primaryText, secondaryText: secondaryText, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition, forceAddonWrap: forceAddonWrap }, { children: children }), void 0), ripples] }), void 0), group] }), void 0));
});
