...
_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(list_1.List, __assign({}, props, { ref: ref, id: id, "aria-activedescendant": activeId, "aria-multiselectable": multiSelect || undefined, role: "tree", tabIndex: 0, className: (0, classnames_1.default)(block(), className), onBlur: handleBlur, onFocus: handleFocus, onKeyDown: handleKeyDown }, { children: renderChildItems(items, 0, []) }), void 0));
});
