...
function LayoutChildren(_a) {
    ...
    var _e = __read((0, react_1.useState)(visible), 2), miniHidden = _e[0], setMiniHidden = _e[1];
    ...
    if (typeof nav === "undefined") {
        nav = ((0, jsx_runtime_1.jsx)(LayoutNavigation_1.LayoutNavigation, __assign({ header: navHeader, headerProps: navHeaderProps, headerTitle: navHeaderTitle, headerTitleProps: navHeaderTitleProps, closeNav: closeNav, closeNavProps: closeNavProps, treeProps: treeProps }, navProps, { onEntered: function (appearing) {
                var _a;
