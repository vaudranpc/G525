...
exports.GridList = (0, react_1.forwardRef)(function GridList(_a, forwardedRef) {
    ...
    if (isRenderFunction(children)) {
        ...
        content = react_1.Children.map(children, function (child) { return child && (0, jsx_runtime_1.jsx)(GridListCell_1.GridListCell, __assign({ clone: clone }, { children: child }), void 0); });
    }
    else {
        content = children;
    }
    return ((0, jsx_runtime_1.jsx)(useGridList_1.GridListSizeProvider, __assign({ value: gridSize }, { children: (0, jsx_runtime_1.jsx)("div", __assign({}, props, gridListProps, { children: content }), void 0) }), void 0));
});
