...
exports.Grid = (0, react_1.forwardRef)(function Grid(_a, ref) {
    ...
    if (clone || wrapOnly) {
        content = react_1.Children.map(children, function (child) { return child && (0, jsx_runtime_1.jsx)(GridCell_1.GridCell, __assign({ clone: clone }, { children: child }), void 0); });
    }
    return ((0, jsx_runtime_1.jsx)("div", __assign({}, props, { ref: ref, style: mergedStyle, className: mergedClassName }, { children: content }), void 0));
});
