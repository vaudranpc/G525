...
function useTabIndicatorStyle(_a) {
    ...
    var _b = __read((0, react_1.useState)(function () {
        var _a;
        var tabWidth = "".concat(100 / totalTabs, "%");
        return _a = {},
    ...
    var updateCSSVars = (0, react_1.useCallback)(function (itemRefs, activeIndex) {
        ...
        var nextCSSVars = (_a = {},
            _a[TAB_WIDTH_VAR] = "".concat(activeTab.offsetWidth, "px"),
            _a[TAB_OFFSET_VAR] = "".concat(activeTab.offsetLeft, "px"),
            _a);
    ...
    var _c = __read((0, utils_1.useResizeObserver)(updateStyles, {
        ref: propRef,
    }), 2), tabsRef = _c[0], tabsRefHandler = _c[1];
