...
import { CSSTransitionClassNames, CSSTransitionComponentProps, TransitionActions, TransitionTimeout } from "@react-md/transition";
export interface TabPanelProps extends HTMLAttributes<HTMLDivElement>, CSSTransitionComponentProps, TransitionActions {
    /**
...
/** @remarks \@since 4.0.0 */
export declare const DEFAULT_TABPANEL_CLASSNAMES: Readonly<CSSTransitionClassNames>;
/**
