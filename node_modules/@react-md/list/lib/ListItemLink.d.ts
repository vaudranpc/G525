 ...
 */
export declare const ListItemLink: import("react").ForwardRefExoticComponent<(ListItemLinkProps | Pick<ListItemLinkWithComponentProps, keyof ListItemLinkWithComponentProps>) & import("react").RefAttributes<HTMLAnchorElement | ElementType<any>>>;
