 ...
 * @remarks \@since 4.0.0
 */
export declare type TypographyType = "headline-1" | "headline-2" | "headline-3" | "headline-4" | "headline-5" | "headline-6" | "subtitle-1" | "subtitle-2" | "body-1" | "body-2" | "caption" | "overline" | "button";
 ...
 * @remarks \@since 4.0.0
 */
export declare type TypographyHTMLElement = HTMLHeadingElement | HTMLParagraphElement | HTMLSpanElement | HTMLDivElement | HTMLButtonElement | HTMLAnchorElement | HTMLBodyElement | HTMLHtmlElement;
/** @remarks \@since 4.0.0 */
export declare type TypographyRenderFunction = (props: {
    className: string;
}) => ReactElement;
 ...
 */
export declare const Typography: import("react").ForwardRefExoticComponent<TypographyProps & import("react").RefAttributes<TypographyHTMLElement>>;
