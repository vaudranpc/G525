...
exports.ExpansionPanel = (0, react_1.forwardRef)(function ExpansionPanel(_a, ref) {
    ...
    var _j = (0, transition_1.useCollapseTransition)({
        style: contentStyle,
    ...
    return ((0, jsx_runtime_1.jsxs)(card_1.Card, __assign({}, props, { id: "".concat(id, "-container"), ref: ref, fullWidth: fullWidth, className: (0, classnames_1.default)(block({ expanded: expanded, "margin-top": marginTop }), className) }, { children: [customHeader || ((0, jsx_runtime_1.jsx)(ExpansionPanelHeader_1.ExpansionPanelHeader, __assign({ "aria-disabled": disabled || undefined, id: id, ref: headerRef, style: headerStyle, className: headerClassName, icon: expanderIcon, expanded: expanded, onClick: onExpandClick, disableTransition: disableTransition }, { children: header }), void 0)), rendered && ((0, jsx_runtime_1.jsx)(card_1.CardContent, __assign({}, elementProps, { id: contentId, "aria-labelledby": id, role: "region", disableSecondaryColor: disableSecondaryColor, disablePadding: disablePadding, disableExtraPadding: true }, { children: children }), void 0))] }), void 0));
});
