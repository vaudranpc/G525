 ...
 * rendered within (so use `<span>` instead of `<div>` for children).
 */
export declare const ExpansionPanelHeader: import("react").ForwardRefExoticComponent<ExpansionPanelHeaderProps & import("react").RefAttributes<HTMLButtonElement>>;
