...
exports.Chip = (0, react_1.forwardRef)(function Chip(_a, ref) {
    ...
    if (!disableContentWrap) {
        content = ((0, jsx_runtime_1.jsx)("span", __assign({ style: contentStyle, className: (0, classnames_1.default)(block("content"), contentClassName) }, { children: children }), void 0));
    }
    ...
    return ((0, jsx_runtime_1.jsxs)(Component, __assign({}, (noninteractable ? {} : buttonProps), props, handlers, { ref: ref, className: (0, classnames_1.default)(block((_b = {},
            ...
            _b)), className) }, { children: [(0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: leftIcon, beforeClassName: isHiddenIcon ? "" : undefined }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: rightIcon, iconAfter: true }, { children: content }), void 0) }), void 0), ripples] }), void 0));
});
