...
/** @remarks \@since 5.0.0 */
export declare type MenuItemGroupProps = LabelRequiredForA11y<Omit<ListProps, "role">> & {
    children: ReactNode;
};
/**
 ...
 * @remarks \@since 5.0.0
 */
export declare const MenuItemGroup: import("react").ForwardRefExoticComponent<MenuItemGroupProps & import("react").RefAttributes<ListElement>>;
