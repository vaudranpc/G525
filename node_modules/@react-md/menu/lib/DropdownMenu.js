...
function DropdownMenu(_a) {
    ...
    if (menuitem) {
        ...
        toggle = ((0, jsx_runtime_1.jsx)(MenuItemButton_1.MenuItemButton, __assign({}, itemProps, { iconRotatorProps: iconRotatorProps }, toggleProps, { ref: toggleRef, visible: visible }, { children: buttonChildren }), void 0));
    }
    else {
        // see `DropdownMenuProps` about this typecast
        var _h = props, buttonChildren = _h.buttonChildren, buttonProps = __rest(_h, ["buttonChildren"]);
        toggle = ((0, jsx_runtime_1.jsx)(MenuButton_1.MenuButton, __assign({}, buttonProps, { iconRotatorProps: iconRotatorProps }, toggleProps, { ref: toggleRef, visible: visible }, { children: buttonChildren }), void 0));
    }
    return ((0, jsx_runtime_1.jsxs)(MenuVisibilityProvider_1.MenuVisibilityProvider, __assign({ visible: visible, setVisible: setVisible }, { children: [toggle, (0, jsx_runtime_1.jsx)(MenuRenderer_1.MenuRenderer, __assign({}, menuProps, { menuRef: menuRef, menuProps: propMenuProps, menuStyle: menuProps.style, menuClassName: menuClassName, sheetProps: sheetProps, sheetStyle: sheetStyle, sheetClassName: sheetClassName, sheetMenuProps: sheetMenuProps, sheetHeader: sheetHeader, sheetFooter: sheetFooter, sheetPosition: sheetPosition, sheetVerticalSize: sheetVerticalSize, onRequestClose: function () { return setVisible(false); }, horizontal: horizontal, renderAsSheet: renderAsSheet, temporary: temporary, portal: portal, portalInto: portalInto, portalIntoId: portalIntoId, appear: appear, enter: enter, exit: exit, onExit: onExit, onExiting: onExiting, timeout: timeout, classNames: classNames }, { children: children }), void 0)] }), void 0));
}
