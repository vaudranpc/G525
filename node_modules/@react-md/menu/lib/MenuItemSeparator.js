...
var styles = (0, utils_1.bem)("rmd-divider");
/**
...
exports.MenuItemSeparator = (0, react_1.forwardRef)(function MenuItemSeparator(_a, ref) {
    ...
    var horizontal = (0, MenuConfigurationProvider_1.useMenuConfiguration)().horizontal;
    var vertical = propVertical !== null && propVertical !== void 0 ? propVertical : horizontal;
    var heightProps = (0, divider_1.useVerticalDividerHeight)({
        ref: ref,
        style: style,
        maxHeight: vertical ? maxHeight !== null && maxHeight !== void 0 ? maxHeight : 1 : 0,
    });
    return ((0, jsx_runtime_1.jsx)("li", __assign({}, props, heightProps, { "aria-orientation": vertical ? "vertical" : undefined, role: "separator", className: (0, classnames_1.default)(styles({ inset: inset && !vertical, vertical: vertical }), className) }, { children: children }), void 0));
});
