...
import type { BaseMenuRendererProps, MenuTransitionProps, ProvidedMenuProps } from "./types";
/**
 * @internal
 * @remarks \@since 5.0.0
 */
export declare type MenuRendererProps = ProvidedMenuProps & BaseMenuRendererProps & MenuTransitionProps & {
