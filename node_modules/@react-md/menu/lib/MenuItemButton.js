 ...
 * @remarks \@since 5.0.0
 */
exports.MenuItemButton = (0, react_1.forwardRef)(function MenuItemButton(_a, ref) {
    ...
    var root = (0, MenuBarProvider_1.useMenuBarContext)().root;
    var focusId = (0, MenuBarWidget_1.useMenuBarWidgetFocusId)();
    var dropdownIcon = (0, icon_1.useIcon)(root ? "dropdown" : "forward");
    var rightAddon = propRightAddon;
    if (!disableDropdownIcon) {
        rightAddon = ((0, jsx_runtime_1.jsx)(icon_1.IconRotator, __assign({}, iconRotatorProps, { rotated: visible }, { children: dropdownIcon }), void 0));
    }
    return ((0, jsx_runtime_1.jsx)(MenuItem_1.MenuItem, __assign({}, props, { id: id, ref: ref, rightAddon: rightAddon, tabIndex: tabIndex !== null && tabIndex !== void 0 ? tabIndex : (root && id === focusId ? 0 : -1) }, { children: children }), void 0));
});
