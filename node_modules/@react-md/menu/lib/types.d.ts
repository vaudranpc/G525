...
import type { CalculateFixedPositionOptions, KeyboardFocusHookOptions, LabelA11y, PositionAnchor, RequireAtLeastOne } from "@react-md/utils";
import type { CSSProperties, Dispatch, HTMLAttributes, KeyboardEventHandler, MouseEventHandler, ReactNode, Ref, RefObject, SetStateAction } from "react";
/** @remarks \@since 5.0.0 */
export declare type MenuTransitionProps = Omit<ScaleTransitionHookOptions<HTMLDivElement>, "transitionIn" | "vertical" | "nodeRef">;
/** @remarks \@since 5.0.0 */
 ...
 * @remarks \@since 5.0.0
 */
export declare type RenderMenuAsSheet = boolean | "phone";
/** @remarks \@since 5.0.0 */
...
/** @remarks \@since 5.0.0 */
export declare type MenuConfigurationContext = Required<MenuConfiguration>;
/** @remarks \@since 5.0.0 */
export interface MenuWidgetProps extends HTMLAttributes<HTMLDivElement>, KeyboardFocusHookOptions<HTMLDivElement>, MenuOrientationProps {
    /**
...
/** @remarks \@since 5.0.0 */
export interface MenuProps extends RenderConditionalPortalProps, MenuTransitionProps, MenuWidgetProps {
    /**
 ...
 * @remarks \@since 5.0.0
 */
export declare type ProvidedMenuProps = Required<Pick<MenuProps, "id" | "style" | "visible" | "onClick" | "onKeyDown">> & Required<FixedPositioningTransitionCallbacks> & RequireAtLeastOne<LabelA11y>;
/**
...
/** @remarks \@since 5.0.0 */
export declare type MenuButtonTextIconSpacingProps = Pick<TextIconSpacingProps, "icon" | "iconAfter">;
/** @remarks \@since 5.0.0 */
export declare type MenuButtonIconRotatorProps = Omit<IconRotatorProps, "children" | "rotated">;
/** @remarks \@since 5.0.0 */
export interface BaseMenuButtonProps extends ButtonProps, MenuButtonTextIconSpacingProps {
     ...
     */
    textIconSpacingProps?: Readonly<Omit<TextIconSpacingProps, "children" | keyof MenuButtonTextIconSpacingProps>>;
}
/** @remarks \@since 5.0.0 */
export interface BaseMenuRendererProps extends RenderConditionalPortalProps, MenuConfiguration {
     ...
     */
    menuProps?: Readonly<Omit<MenuWidgetProps, "id" | "style" | "className" | "children">>;
    /**
     ...
     */
    sheetProps?: Readonly<Omit<SheetProps, "style" | "className" | "onRequestClose" | "children" | "id" | "visible">>;
    /**
...
/** @remarks \@since 5.0.0 */
export interface DropdownMenuButtonProps extends BaseMenuButtonProps, BaseDropdownMenuProps, MenuButtonTextIconSpacingProps {
    /**
...
/** @remarks \@since 5.0.0 */
export interface DropdownMenuItemProps extends BaseDropdownMenuProps, BaseMenuItemButtonProps {
    /**
 ...
 * @remarks \@since 5.0.0
 */
export declare type DropdownMenuProps = DropdownMenuButtonProps | DropdownMenuItemProps;
