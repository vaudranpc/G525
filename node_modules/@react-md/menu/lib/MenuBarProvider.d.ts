 ...
 * @remarks \@since 5.0.0
 */
export declare function useMenuBarContext(): Readonly<MenuBarContext>;
/**
 * @internal
 * @remarks \@since 5.0.0
 */
 ...
 * @remarks \@since 5.0.0
 */
export declare function MenuBarProvider({ children, root, defaultActiveId, hoverTimeout, }: MenuBarProviderProps): ReactElement;
