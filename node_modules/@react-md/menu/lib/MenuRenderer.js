...
function MenuRenderer(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(MenuConfigurationProvider_1.MenuConfigurationProvider, __assign({ horizontal: horizontal, renderAsSheet: renderAsSheet, sheetHeader: sheetHeader, sheetFooter: sheetFooter, sheetPosition: sheetPosition, sheetVerticalSize: sheetVerticalSize }, { children: [!sheet && ((0, jsx_runtime_1.jsx)(Menu_1.Menu, __assign({}, props, menuProps, handlers, { ref: menuRef, style: menuStyle, className: menuClassName, horizontal: horizontal }, { children: children }), void 0)), sheet && ((0, jsx_runtime_1.jsx)(MenuSheet_1.MenuSheet, __assign({}, props, sheetProps, { style: sheetStyle, className: sheetClassName, horizontal: horizontal, onRequestClose: onRequestClose, header: sheetHeader, footer: sheetFooter, menuRef: menuRef, menuProps: __assign(__assign({}, sheetMenuProps), handlers), position: sheetPosition, verticalSize: sheetVerticalSize }, { children: children }), void 0))] }), void 0));
}
