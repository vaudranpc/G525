...
function MenuBarWidget(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Provider, __assign({ value: focusId }, { children: (0, jsx_runtime_1.jsx)(list_1.List, __assign({}, props, { role: "menubar", horizontal: true, tabIndex: tabIndex !== null && tabIndex !== void 0 ? tabIndex : (focusId ? -1 : 0), onFocus: onFocus, onKeyDown: onKeyDown }, { children: children }), void 0) }), void 0));
}
