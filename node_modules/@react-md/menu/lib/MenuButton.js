...
exports.MenuButton = (0, react_1.forwardRef)(function MenuButton(_a, ref) {
    ...
    if (!disableDropdownIcon) {
        icon = ((0, jsx_runtime_1.jsx)(icon_1.IconRotator, __assign({}, iconRotatorProps, { rotated: visible }, { children: dropdownIcon }), void 0));
    }
    return ((0, jsx_runtime_1.jsx)(button_1.Button, __assign({}, props, { ref: ref, theme: theme, themeType: themeType, buttonType: buttonType, floating: floating }, { children: (0, jsx_runtime_1.jsx)(icon_1.TextIconSpacing, __assign({ icon: icon, iconAfter: iconAfter }, textIconSpacingProps, { children: children }), void 0) }), void 0));
});
