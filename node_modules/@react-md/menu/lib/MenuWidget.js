...
exports.MenuWidget = (0, react_1.forwardRef)(function MenuWidget(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(MenuBarProvider_1.MenuBarProvider, __assign({ root: false, defaultActiveId: props.id }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ "aria-orientation": horizontal ? "horizontal" : undefined }, props, { ref: ref, role: "menu", onFocus: onFocus, onKeyDown: onKeyDown, tabIndex: tabIndex, className: (0, classnames_1.default)(styles({ horizontal: horizontal, elevated: !disableElevation }), className) }, { children: children }), void 0) }), void 0));
});
