...
export var MenuItemLink = forwardRef(function MenuItemLink(_a, nodeRef) {
    ...
    return (_jsx("li", __assign({}, liProps, { role: "none" }, { children: _jsx(ListItemLink, __assign({}, props, { ref: ref, role: role, tabIndex: tabIndex, className: cn("rmd-menu-item", className) }, { children: children }), void 0) }), void 0));
});
