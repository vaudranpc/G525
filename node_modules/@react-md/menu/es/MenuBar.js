...
export function MenuBar(_a) {
    ...
    return (_jsx(MenuBarProvider, __assign({ hoverTimeout: hoverTimeout }, { children: _jsx(KeyboardMovementProvider, __assign({ loopable: true, searchable: true, incrementKeys: ["ArrowRight"], decrementKeys: ["ArrowLeft"] }, { children: _jsx(MenuBarWidget, __assign({}, props), void 0) }), void 0) }), void 0));
}
