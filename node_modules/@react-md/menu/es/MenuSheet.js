...
export function MenuSheet(_a) {
    var id = _a.id, children = _a.children, header = _a.header, footer = _a.footer, horizontal = _a.horizontal, menuRef = _a.menuRef, menuProps = _a.menuProps, _b = _a.position, position = _b === void 0 ? "bottom" : _b, _c = _a.verticalSize, verticalSize = _c === void 0 ? "touch" : _c, onClick = _a.onClick, overlayProps = _a.overlayProps, onRequestClose = _a.onRequestClose, props = __rest(_a, ["id", "children", "header", "footer", "horizontal", "menuRef", "menuProps", "position", "verticalSize", "onClick", "overlayProps", "onRequestClose"]);
    ...
    return (_jsxs(Sheet, __assign({ id: "".concat(id, "-sheet") }, props, { onRequestClose: onRequestClose, overlayProps: __assign(__assign({}, overlayProps), { onClick: function (event) {
                var _a;
            ...
            if (!(event.target instanceof HTMLElement) ||
                ...
                event.stopPropagation();
        ...
        } }, { children: [header, _jsx(MenuKeyboardFocusProvider, __assign({ horizontal: horizontal }, { children: _jsx(MenuWidget, __assign({ "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, id: id, ref: menuRef, tabIndex: focused ? -1 : 0 }, menuProps, { onFocus: function (event) {
                        var _a;
                    ...
                    }, disableElevation: true }, { children: _jsx(List, __assign({ ref: listRef, horizontal: horizontal, onClick: function (event) {
                            // this makes it so you can click on the menu/list without
                            // closing the menu
                            if (event.target === event.currentTarget) {
                                event.stopPropagation();
                            }
                        } }, { children: children }), void 0) }), void 0) }), void 0), footer] }), void 0));
}
