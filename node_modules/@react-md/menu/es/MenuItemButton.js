...
export var MenuItemButton = forwardRef(function MenuItemButton(_a, ref) {
    ...
    if (!disableDropdownIcon) {
        rightAddon = (_jsx(IconRotator, __assign({}, iconRotatorProps, { rotated: visible }, { children: dropdownIcon }), void 0));
    }
    return (_jsx(MenuItem, __assign({}, props, { id: id, ref: ref, rightAddon: rightAddon, tabIndex: tabIndex !== null && tabIndex !== void 0 ? tabIndex : (root && id === focusId ? 0 : -1) }, { children: children }), void 0));
});
