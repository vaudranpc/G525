...
export var MenuButton = forwardRef(function MenuButton(_a, ref) {
    ...
    if (!disableDropdownIcon) {
        icon = (_jsx(IconRotator, __assign({}, iconRotatorProps, { rotated: visible }, { children: dropdownIcon }), void 0));
    }
    return (_jsx(Button, __assign({}, props, { ref: ref, theme: theme, themeType: themeType, buttonType: buttonType, floating: floating }, { children: _jsx(TextIconSpacing, __assign({ icon: icon, iconAfter: iconAfter }, textIconSpacingProps, { children: children }), void 0) }), void 0));
});
