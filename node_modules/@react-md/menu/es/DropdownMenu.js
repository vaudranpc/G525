...
export function DropdownMenu(_a) {
    ...
    if (menuitem) {
        ...
        toggle = (_jsx(MenuItemButton, __assign({}, itemProps, { iconRotatorProps: iconRotatorProps }, toggleProps, { ref: toggleRef, visible: visible }, { children: buttonChildren }), void 0));
    }
    else {
        // see `DropdownMenuProps` about this typecast
        var _h = props, buttonChildren = _h.buttonChildren, buttonProps = __rest(_h, ["buttonChildren"]);
        toggle = (_jsx(MenuButton, __assign({}, buttonProps, { iconRotatorProps: iconRotatorProps }, toggleProps, { ref: toggleRef, visible: visible }, { children: buttonChildren }), void 0));
    }
