...
export var MenuItemSeparator = forwardRef(function MenuItemSeparator(_a, ref) {
    ...
    return (_jsx("li", __assign({}, props, heightProps, { "aria-orientation": vertical ? "vertical" : undefined, role: "separator", className: cn(styles({ inset: inset && !vertical, vertical: vertical }), className) }, { children: children }), void 0));
});
