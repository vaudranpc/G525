...
export var MenuWidget = forwardRef(function MenuWidget(_a, ref) {
    ...
    return (_jsx(MenuBarProvider, __assign({ root: false, defaultActiveId: props.id }, { children: _jsx("div", __assign({ "aria-orientation": horizontal ? "horizontal" : undefined }, props, { ref: ref, role: "menu", onFocus: onFocus, onKeyDown: onKeyDown, tabIndex: tabIndex, className: cn(styles({ horizontal: horizontal, elevated: !disableElevation }), className) }, { children: children }), void 0) }), void 0));
});
